...
{p 4 4 2}
import excel "https://raw.githubusercontent.com/timbulwidodostp/lddtest/main/lddtest/lddtest.xlsx", sheet("Sheet1") firstrow clear {break}
lddtest lddtest, breakpoint(1) epsilon (2) {break}
lddtest lddtest, breakpoint(1) epsilon (2) b(1) h(1) alpha(0.1) {break}
...
{browse "https://www.youtube.com/@amalsedekah":https://www.youtube.com/@amalsedekah} 
